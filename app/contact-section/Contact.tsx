      ...
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center pt-10 md:pt-0">
        ...
        <div className="mt-20 flex w-full flex-col items-end justify-center gap-16 sm:mt-32 sm:gap-12 md:mt-40 md:flex-row md:items-start md:justify-between lg:mt-12 lg:max-w-[1440px]">
          <div className="flex w-[350px] max-w-[90%] flex-col items-end text-right text-[14px] font-semibold uppercase text-[#e4ded7] sm:w-[350px] sm:text-[14px] md:w-[310px] md:items-start md:text-left md:text-[16px] lg:w-[420px] lg:text-[16px]">
            ...
            />
            {/* --- REVISED FOCUS ON THIS DIV --- */}
            {/* Using 'justify-center' for horizontal centering on small screens */}
            {/* Using 'gap-4' (or adjust as needed) for spacing between items */}
            {/* Adjusted the width of the container for better responsiveness */}
            <div className="mt-5 flex w-full items-center justify-center gap-4 md:w-[335px] md:justify-start md:gap-2.5 lg:w-auto">
              ...
              >
                <AnimatedBody
                  ...
                  // Ensured text doesn't wrap unnecessarily on larger screens
                  className={
                    "whitespace-nowrap text-[14px] leading-tight sm:text-[14px] md:text-[16px]"
                  }
                />
              </Link>
              <AnimatedBody
                text={"or"}
                className={
                  "mx-2 whitespace-nowrap text-[14px] leading-tight sm:text-[14px] md:text-[16px]"
                }
              />
              <Link
